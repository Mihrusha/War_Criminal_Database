...
$path_to_file = 'counter4.txt';//будет зависеть от вашего желания и структуры ваших адресов сайта
  	...
  	<div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
		  ...
		  style="max-width: 30rem; width: 100%"
		   method="POST" action="">
  			...
  			<input type="submit" name='reg' id='Reg' class="btn btn-primary border-2" value="Registration">
  				</button>
